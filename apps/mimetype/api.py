...
def get_icon_file_path(mimetype):
    ...
    if settings.DEVELOPMENT:
        return os.path.join(settings.PROJECT_DIR, 'apps', 'mimetype', 'static', MIMETYPE_ICONS_DIRECTORY_NAME, file_name)
    else:
...
def get_error_icon_file_path():
    if settings.DEVELOPMENT:
        return os.path.join(settings.PROJECT_DIR, 'apps', 'mimetype', 'static', MIMETYPE_ICONS_DIRECTORY_NAME, ERROR_FILE_NAME)
    else:
